...
/* error */
.error{ color:#ff3b3b; margin-top:10px; }
...
Ce site est créé pour aider les petits créateurs de script qui n’ont pas d’inspiration.
<br>
...
footer:"Ce site est créé pour aider les petits créateurs de script qui n’ont pas d’inspiration."
},
en:{
...
footer:"This site helps small creators edit scripts faster."
}
};

function getLang(){
let lang=(navigator.language||"fr").toLowerCase();
...
document.getElementById("error").innerText=t[getLang()].error;
return;
}

document.getElementById("preview").innerHTML=
script.replace(regex,m=>"<span class='highlight'>"+m+"</span>");
}
